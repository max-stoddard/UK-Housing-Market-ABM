            ...
            writer.writerow(
                {
                    ...
                    "lossFamily": metric.get("lossFamily"),
                    "lossTransform": metric.get("lossTransform"),
                    "lossScale": metric.get("lossScale"),
                    "lossScaleBasis": metric.get("lossScaleBasis"),
                    "additiveScale": metric.get("additiveScale"),
                    "additiveScaleBasis": metric.get("additiveScaleBasis"),
                    "normalizedDistance": metric.get("normalizedDistance"),
                    "normalizedIqr": metric.get("normalizedIqr"),
                    "distanceComponent": metric.get("distanceComponent"),
                    "spreadComponent": metric.get("spreadComponent"),
                    "levelComponent": metric.get("levelComponent"),
                    "insideRateComponent": metric.get("insideRateComponent"),
